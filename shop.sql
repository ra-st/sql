...
INSERT INTO products (product_id,name,price,total_count,category,added_at,added_by,shop)
    VALUES (1,'TEST 1',100000,10,1,now(),'+989363236021',1),
           ...
           (3,'TEST 3',200000,10,1,now(),'+989363236023',1),
           (4,'TEST 4',246000,10,1,now(),'+989363236024',2),
           (5,'TEST 5',197000,10,1,now(),'+989363236025',2),
           (6,'TEST 6',658400,10,1,now(),'+989363236026',2),
           (7,'TEST 7',6546000,10,1,now(),'+989363236027',3),
           (8,'TEST 8',69868400,10,1,now(),'+989363236028',3),
           (9,'TEST 9',9846500000,10,1,now(),'+989363236029',3),
           (10,'TEST 9',999999999999,10,1,now(),'+989363236029',3),
           (11,'TEST 9',6546541,10,1,now(),'+989363236029',3),
           (12,'TEST 9',97658454,10,1,now(),'+989363236029',3),
           (13,'TEST 9',987654,10,1,now(),'+989365766029',3),
           (14,'TEST 9',4654,10,1,now(),'+989366576029',3),
           (15,'TEST 9',6879456,10,1,now(),'+989356776729',3),
           (16,'TEST 9',987654,10,1,now(),'+989363567029',3),
           (17,'TEST 9',868,10,1,now(),'+989385556029',3),
           (18,'TEST 9',6,10,1,now(),'+989384566029',3),
           (19,'TEST 9',9876984,10,1,now(),'+989564688029',3),
           (20,'TEST 9',68497,10,1,now(),'+989865465489',3),
           (21,'TEST 9',6546,10,1,now(),'+989354686549',3),
           (22,'TEST 9',6849/8,10,1,now(),'+989397645629',3),
           (23,'TEST 9',65489,10,1,now(),'+989387656469',3),
